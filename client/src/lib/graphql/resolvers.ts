...
export const resolvers ={
    Query:{
        ...
        specific_seller_contact(_:unknown, args: { id: string}){
            return _db.contacts.find((car)=>car.id===args.id)
        }
     ...
     Tires:{
       ...
       SellerContact:{
          cars(parent:{ id: string }){
            return _db.cars.filter((car)=>car.specificSellerContact_id===parent.id)
        },
        newarrivals(parent:{ id: string }){
            return _db.newarrivals.filter((car)=> car.specificSellerContact_id===parent.id)
        },
        special_car_deals(parent:{ id: string }){
            return _db.special_car_deals.filter((car)=> car.specificSellerContact_id===parent.id)
        },
        suv_pickups(parent:{ id: string }){
            return _db.suv_pickups.filter((car)=> car.specificSellerContact_id===parent.id)
        } 
      },
     Car:{
        ...
        specific_seller_contact(parent:{specificSellerContact_id: string }){
            return _db.contacts.find((car)=>car.id===parent.specificSellerContact_id)
        }
