  ...
  return (
    <header className=" text-skyBlue sm:h-14 h-10  bg-transparent mt-1 rounded-4xl sm:w-auto w-auto ">
      <ul className="flex justify-end sm:pt-4 pt-2 ">
        <li className={`${josefinFont.className}  sm:text-xl text-sm cursor-pointer hover:text-lightGray hover:border-darkSky hover:bg-darkSky transition-colors duration-300 w-[50px] h-[30px] rounded-4xl pl-2`}><Link   href="/dashboard">Logo</Link></li>
